...
// ─────────────────────────────────────────────────────────────────────────────
// GetButton — small pill (list/grid rows) or large section (details page)
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// Large download section — details page.
// Uses context.watch so it rebuilds live on every progress tick.
// CRITICAL FIX: always uses widget.app directly, never task?.app
// ─────────────────────────────────────────────────────────────────────────────
...
class _LargeSectionState extends State<_LargeSection>
  ...
  @override
  Widget build(BuildContext context) {
    // context.watch — rebuild on every progress update
    final dl = context.watch<DownloadsProvider>();
    final task = dl.getTask(widget.app.id);
    final status = task?.status;
...
// ─────────────────────────────────────────────────────────────────────────────
// Control pill (Pause / Resume / Cancel)
// ─────────────────────────────────────────────────────────────────────────────
