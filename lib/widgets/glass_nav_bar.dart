            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: Colors.black
                        .withOpacity(t.isDark ? 0.35 : 0.12),
                    blurRadius: 28,
...
class _NavItemState extends State<_NavItem>
  ...
  void initState() {
    ...
    _bounce = TweenSequence([
      TweenSequenceItem(
          tween: Tween(begin: 1.0, end: 0.80), weight: 40),
      TweenSequenceItem(
          tween: Tween(begin: 0.80, end: 1.05), weight: 35),
      TweenSequenceItem(
          tween: Tween(begin: 1.05, end: 1.0), weight: 25),
        ...
        child: AnimatedBuilder(
          ...
          builder: (_, __) => Container(
            padding: EdgeInsets.symmetric(
              horizontal: 12.0 + (4.0 * _pillWidth.value),
              vertical: 7,
            ),
            decoration: BoxDecoration(
              color: AppColors.accent
                  .withOpacity(0.14 * _pillWidth.value),
